...
<div class="page-head">
  <div>
    <h1>Riwayat data</h1>
    <p class="sub">Catatan dibuat, diubah, dihapus, dan dipulihkan. Hanya superadmin yang bisa memulihkan data terhapus.</p>
  </div>
</div>

<form class="toolbar-form" method="get" style="margin-bottom:14px">
  <select name="subject">
